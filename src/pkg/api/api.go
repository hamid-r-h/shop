...
func SetupRoutes(app *fiber.App) {
	...
	private_product.Post("/addfavourite/:productid", favourite.AddToFavourite)
	private_product.Delete("/removefavourite/:productid", favourite.RemoveFromFavourite)

	private_comment:=private.Group("/comment")
	private_comment.Post("/add/:productid",comment.AddComment)
	private_comment.Post("/reply/:commentid",comment.ReplyOn)
